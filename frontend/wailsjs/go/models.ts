...
export namespace testrepo {
	...
	export class RollupRun {
	    execKey: string;
	    execSummary: string;
	    status: string;
	
	    static createFrom(source: any = {}) {
	        return new RollupRun(source);
	    }
	...
	export class RollupMember {
	    ...
	    static createFrom(source: any = {}) {
	        return new RollupMember(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.testKey = source["testKey"];
	        this.summary = source["summary"];
	        this.consolidated = source["consolidated"];
	        this.runs = this.convertValues(source["runs"], RollupRun);
	    }
	...
	export class StageFailure {
	    ...
	    static createFrom(source: any = {}) {
	        return new StageFailure(source);
	    }
	...
	export class SyncLogEntry {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.error = source["error"];
	        this.stageFailures = this.convertValues(source["stageFailures"], StageFailure);
	    }
